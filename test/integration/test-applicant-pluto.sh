...
mvn verify -Dintegration.port=9080 -P selenium,pluto -Dit.test='!ADF*ApplicantPortletTester,!*CDI*Applicant*,*Applicant*'
#mvn verify -Dintegration.port=9080 -P selenium,pluto -Dit.test=\*JSFApplicant\*
