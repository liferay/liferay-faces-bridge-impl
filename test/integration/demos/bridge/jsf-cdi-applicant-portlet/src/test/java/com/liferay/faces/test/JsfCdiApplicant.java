 ...
 */
public class JsfCdiApplicant extends TesterBase {

	protected static final Logger logger = Logger.getLogger(JsfCdiApplicant.class.getName());
	...
	static final String url = baseUrl + webContext + "/jsf-cdi-applicant";
