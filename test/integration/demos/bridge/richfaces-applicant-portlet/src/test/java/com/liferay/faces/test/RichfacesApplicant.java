 ...
 */
public class RichfacesApplicant extends TesterBase {

	protected static final Logger logger = Logger.getLogger(RichfacesApplicant.class.getName());
	...
	static final String url = baseUrl + webContext + "/richfaces-applicant";
