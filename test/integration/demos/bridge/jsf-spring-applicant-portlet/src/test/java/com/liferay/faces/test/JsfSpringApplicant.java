 ...
 */
public class JsfSpringApplicant extends TesterBase {

	protected static final Logger logger = Logger.getLogger(JsfSpringApplicant.class.getName());
	...
	static final String url = baseUrl + webContext + "/jsf-spring-applicant";
