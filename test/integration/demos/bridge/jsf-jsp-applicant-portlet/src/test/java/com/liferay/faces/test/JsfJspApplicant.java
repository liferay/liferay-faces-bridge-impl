 ...
 */
public class JsfJspApplicant extends TesterBase {

	protected static final Logger logger = Logger.getLogger(JsfJspApplicant.class.getName());
	...
	static final String url = baseUrl + webContext + "/jsf-jsp-applicant";
