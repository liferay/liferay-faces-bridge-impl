 ...
 */
public class Icefaces1 extends TesterBase {

	protected static final Logger logger = Logger.getLogger(Icefaces1.class.getName());
	...
	// <a class="dropdown-toggle direction-down max-display-items-15" href="javascript:;" id="_1_WAR_jsf1portlet_INSTANCE_ABCD_kldx_menu" title="Options">
