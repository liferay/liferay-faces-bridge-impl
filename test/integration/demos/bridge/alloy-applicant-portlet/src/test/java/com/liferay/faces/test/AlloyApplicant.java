 ...
 */
public class AlloyApplicant extends TesterBase {

	protected static final Logger logger = Logger.getLogger(AlloyApplicant.class.getName());
	...
	static final String url = baseUrl + webContext + "/alloy-applicant";
