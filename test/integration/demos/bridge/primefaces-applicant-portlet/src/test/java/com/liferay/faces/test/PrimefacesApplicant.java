 ...
 */
public class PrimefacesApplicant extends TesterBase {

	protected static final Logger logger = Logger.getLogger(PrimefacesApplicant.class.getName());
	...
	static final String url = baseUrl + webContext + "/primefaces-applicant";
