 ...
 */
public class JsfHtml5Applicant extends TesterBase {

	protected static final Logger logger = Logger.getLogger(JsfHtml5Applicant.class.getName());
	...
	static final String url = baseUrl + webContext + "/jsf-html5-applicant";
