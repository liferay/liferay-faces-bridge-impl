...
public class PreferencesBacking {
	...
	/**
	 * Resets/restores the values in the preferences.jspx fragment with portlet preference default values.
	 */
	public void reset() {
	...
	/**
	 * Saves the values in the preferences.jspx fragment as portlet preferences.
	 */
	public void submit() {

		// The JSR 329 specification defines an EL variable named mutablePortletPreferencesValues that is being used in
		// the preferences.jspx fragment. This object is of type Map<String, Preference> and is
