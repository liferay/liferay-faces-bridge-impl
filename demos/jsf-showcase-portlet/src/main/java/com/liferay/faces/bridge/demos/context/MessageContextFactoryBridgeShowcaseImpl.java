 ...
 * @author  Neil Griffin
 */
public class MessageContextFactoryBridgeShowcaseImpl extends MessageContextFactory {

	// Private Data Members
	private MessageContextFactory wrappedMessageContextFactory;
	private MessageContext messageContext;

	public MessageContextFactoryBridgeShowcaseImpl(MessageContextFactory messageContextFactory) {
		...
		this.messageContext = new MessageContextBridgeShowcaseImpl(wrappedMessageContext);
	}
