...
public abstract class RenderURLRendererCompat extends RenderURLRendererBase {
	...
	protected PortletURL createRenderURL(ExternalContext externalContext, ParamCopyOption paramCopyOption) {

		MimeResponse mimeResponse = (MimeResponse) externalContext.getResponse();
		PortletURL renderURL = mimeResponse.createRenderURL();

		if (paramCopyOption == ParamCopyOption.ALL_PUBLIC_PRIVATE) {
			copyCurrentRenderParameters(externalContext, renderURL);
		}
