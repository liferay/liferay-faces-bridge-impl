...
public abstract class ELResolverCompatImpl extends ELResolver {
	...
	static {
		...
		FEATURE_DESCRIPTORS_COMPAT = Collections.unmodifiableList(Collections.EMPTY_LIST);
	}
	...
	protected PortletConfig unwrapPortletConfig(PortletConfig portletConfig) {
		...
		while ((portletConfig instanceof Wrapper) && (portletConfig instanceof PortletConfig)) {
			Wrapper<PortletConfig> portletConfigWrapper = (Wrapper<PortletConfig>) portletConfig;
