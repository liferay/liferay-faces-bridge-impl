	...
	public Bridge getBridge() throws PortletException {
		...
		if (serviceLoader != null) {
			...
			if (bridge != null) {
				...
				throw new PortletException("Unable locate service for " + Bridge.class.getName());
			}
		}
		else {
			throw new PortletException("Unable to acquire ServiceLoader for " + Bridge.class.getName());
		}
	}
