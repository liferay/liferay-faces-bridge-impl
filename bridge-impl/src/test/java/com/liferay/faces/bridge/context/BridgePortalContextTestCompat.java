...
public class BridgePortalContextTestCompat {
	...
	protected void testBridgePortalContextAddToHeadSupport(PortalContext portalContextBridgeImpl,
		...
		// JSF 1.2 does not support any <head> section features, so all BridgePortalContext.ADD_*_TO_HEAD_SUPPORT
		// properties (such as ADD_ELEMENT_TO_HEAD_SUPPORT) should return null.
